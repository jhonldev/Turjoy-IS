...
<body class="bg-grey-custom-neutral">
    ...
    <div id="drawer_navigation"
        class="fixed rounded-tl-lg top-[110px] right-0 z-40 h-[calc(100vh-60px)] p-4 overflow-y-auto transition-transform translate-y-full  w-80 bg-grey-custom-dark tabindex="-1"
        aria-labelledby="drawer-right-label" style="border-top-left-radius: 1.1rem;">
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-2 font-medium">
                @guest
                    <li>
                        <a href="{{ route('login') }}"
                            ...
                            <img src="{{ asset('http://127.0.0.1:8000/images/icono-user.png') }}" alt="Icono iniciar sesion"
                                class="w-14 h-12 mr-1">
                ...
                @auth
                    <li>
                        <a class="flex items-center p-2 rounded-lg text-white">
                            <img src="{{ asset('http://127.0.0.1:8000/images/icono-user.png') }}" alt="Icono usuario"
                                class="w-14 h-12 mr-1">
                    ...
                    <li>
                        <a href="{{ route('routes.index') }}"
                            class="flex items-center p-2 rounded-lg text-white hover:bg-blue-custom-blueSmoke">
                            <img src="{{ asset('http://127.0.0.1:8000/images/icono-pagina.png') }}"
                                alt="Cargar rutas de viaje" class="w-10 h-12 ml-2 mr-3">
                ...
                @guest
                    <li>
                        <a href="{{ route('home') }}"
                            class="flex items-center p-2 rounded-lg text-white hover:bg-blue-custom-blueSmoke">
                            <img src="{{ asset('http://127.0.0.1:8000/images/icono-reservar-pasaje.png') }}"
                                alt="Reservar pasajes" class="w-14 h-12 mr-1">
                ...
                <li>
                    <a href="{{ route('search.index') }}"
                        ...
                        <img src="{{ asset('http://127.0.0.1:8000/images/icono-consultar-reserva.png') }}"
                            alt="Buscar reservas" class="w-12 h-12 mr-2 ml-1">
                ...
                @auth
                    ...
                    <li>
                        <a method="GET" href="{{ route('logout') }}"
                            class="flex items-center p-2 rounded-lg text-white hover:bg-blue-custom-blueSmoke">
                            <img src="{{ asset('http://127.0.0.1:8000/images/icono-salida.png') }}"
                                alt="Reporte de reservas" class="w-12 h-12 mr-2 ml-1">
